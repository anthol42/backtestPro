from ..engine import Account, Broker, Portfolio, TradeOrder, TradeType, TSData, Strategy
...
class StateSignals:
    ...
    def __init__(self, account: Account, broker: Broker, signals: Dict[str, TradeOrder], strategy: Strategy,timestamp: datetime,
