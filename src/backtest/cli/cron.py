...
class Cron(CliApp):
    ...
    def add(self, path: str, name: str, m: str = "*", h: str = "*", dom: str = "*", mon: str = "*", dow: str = "*",
        ...
        :param path: Path to the file to run (The job)
        :param name: The name of the job (Must be unique)
        :param m: The minute expression
        :param h: The Hour expression
        :param dom: The Day of Month expression
        :param mon: The month expression
        :param dow: The Day of Week expression
