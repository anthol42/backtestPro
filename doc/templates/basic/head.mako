                    ...
                    <div class="navbar-center-item">
                        <ul class="navbar-nav" id="navbar-main-elements">
                            <li class="toctree-l1 nav-item">
                                <a class="reference internal nav-link ${'active' if page_id == 'home' else ''}" href="#">
                                    Home
                                </a>
                            </li>

                            <li class="toctree-l1 nav-item">
                                <a class="reference internal nav-link ${'active' if page_id == 'get_started' else ''}" href="#">
                                    Get Started
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link nav-external ${'active' if page_id == 'about' else ''}" href="#">About</a>
                            </li>
